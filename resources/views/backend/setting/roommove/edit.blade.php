        ...
        <div class="bg-white block w-full overflow-x-auto p-8">
            ...
            <form method="post" action="/dashboard/kasi/report/{{ $item->id }}" enctype="multipart/form-data">
                ...
                <div class="bg-gray-50 border border-gray-200 shadow-sm rounded-xl p-6 mb-8">
                    ...
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Asal Nomor Surat</label>
                        <input type="text" value="{{ $item->letter->no }}" disabled
